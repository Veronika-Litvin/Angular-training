...
export const users: IUser[] = [
    {id: 1, firstName: 'Masha', lastName: 'Ivanova', age: 15, userEmail: 'masha@gmail.com', gender: true, department: 'Java', company: 'ISsoft', imageUrl: '../../../../assets/Masha.jpg', addresses: [{addressLine: "Gorodetskaya 11/2", city: "Minsk", zip: "220021"}, {addressLine: "Stroitelnaya 13", city: "Minsk", zip: "220312"}]},
    ...
    {id: 6, firstName: 'Vika', lastName: 'Simonova', age: 19, userEmail: 'vika@gmail.com', gender: true, department: '.Net', company: 'Playtica', imageUrl: '../../../../assets/Vika.jpg', addresses: [{addressLine: "Shcolnaya 11", city: "Kirov", zip: "093212"}]},
    {id: 7, firstName: 'Petr', lastName: 'Kleban', age: 29, userEmail: 'petr@gmail.com', gender: false, department: 'JS', company: 'ITransition', imageUrl: '../../../../assets/Petr.jpg', addresses: [{addressLine: "Plosa 6", city: "Warsaw", zip: "330051"}]}
  ];
